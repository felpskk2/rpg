...
**Void** é um cenário pós-apocalíptico steampunk ambientado em um deserto infinito. Doze cidades-colmeia gigantescas, dispostas em espiral, são os únicos centros de civilização — cada uma controlada por uma mega-corporação. Fora delas, comunidades de refratários sobrevivem nas Areias, protegidos por facções. Mercenários vagam entre todos os lados, vendendo seus serviços a quem pagar.

## A Espiral

As 12 cidades formam uma espiral no deserto. A numeração segue da borda externa ao centro:
...
> **X** — Centro da espiral (segredo, ruína da guerra, ou algo pior?)

## Estrutura das Cidades-Colmeia

Toda cidade-colmeia possui 3 níveis verticais:

| Nível | Nome | Quem vive | Característica |
|-------|------|-----------|----------------|
